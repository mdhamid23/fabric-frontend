...
async function fetchAuthUserWithProfile(accessToken: string): Promise<AuthUserWithProfile | null> {
    try {
...
export async function getAuthUser(options?: { withProfile?: false }): Promise<DecodedAuthToken | null>;

export async function getAuthUser(options: { withProfile: true }): Promise<AuthUserWithProfile | null>;

export async function getAuthUser(options: GetAuthUserOptions = {}): Promise<DecodedAuthToken | AuthUserWithProfile | null> {
